...
from src.lerobot.cameras.utils import make_cameras_from_configs
from src.lerobot.envs.factory import make_env
from src.lerobot.processor import RobotAction, RobotObservation
from src.lerobot.robots.unitree_g1.g1_kinematics import G1_29_ArmIK
from src.lerobot.robots.unitree_g1.g1_utils import (
    REMOTE_AXES,
    REMOTE_KEYS,
    G1_29_JointArmIndex,
    G1_29_JointIndex,
...
from src.lerobot.utils.import_utils import _unitree_sdk_available
...
class UnitreeG1(Robot):
    ...
    def __init__(self, config: UnitreeG1Config):
        ...
        if config.is_simulation:
            ...
            from src.lerobot.robots.unitree_g1.unitree_sdk2_socket import (
