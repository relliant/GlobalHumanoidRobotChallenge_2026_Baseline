...
from src.lerobot.envs.configs import AlohaEnv, EnvConfig, HubEnvConfig, IsaaclabArenaEnv, LiberoEnv, PushtEnv
from src.lerobot.envs.utils import _call_make_env, _download_hub_file, _import_hub_module, _normalize_hub_result
from src.lerobot.policies.xvla.configuration_xvla import XVLAConfig
from src.lerobot.processor import ProcessorStep
from src.lerobot.processor.env_processor import IsaaclabArenaProcessorStep, LiberoProcessorStep
from src.lerobot.processor.pipeline import PolicyProcessorPipeline
...
def make_env_pre_post_processors(
    ...
    if isinstance(policy_cfg, XVLAConfig):
        from src.lerobot.policies.xvla.processor_xvla import make_xvla_libero_pre_post_processors
...
def make_env(
    ...
    if "libero" in cfg.type:
        from src.lerobot.envs.libero import create_libero_envs
        ...
        from src.lerobot.envs.metaworld import create_metaworld_envs
