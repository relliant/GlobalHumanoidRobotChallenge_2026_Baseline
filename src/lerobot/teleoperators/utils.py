...
from src.lerobot.utils.import_utils import make_device_from_device_class
...
def make_teleoperator_from_config(config: TeleoperatorConfig) -> "Teleoperator":
    ...
    if config.type == "keyboard":
        ...
        from src.lerobot.teleoperators.walker_s2_keyboard.teleop import WalkerS2KeyboardTeleop
